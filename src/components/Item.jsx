...
//         try {
//             if(redcolor==true){
//                 let response = await axios.post(`https://metalapi.herokuapp.com/unlike`, { id: id }, { headers: { "Authorization": `Bearer ${props.token}` } });
//                 setredcolor(!redcolor)
//             }
//             else{
//                 let response = await axios.post(`https://metalapi.herokuapp.com/like`, { id: id }, { headers: { "Authorization": `Bearer ${props.token}` } });
//                 setredcolor(!redcolor)
//             }
//         }
//         catch (error) {
